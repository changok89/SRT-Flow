...
- Audio extracted from selected videos may be stored temporarily on your device for processing and resume support.
...
## 6. Data Sharing
We do not sell your personal data. Data handling by third-party SDKs follows each provider's terms and policies.
...
- 선택한 동영상에서 추출된 오디오는 처리 및 재개 지원을 위해 기기에 임시로 저장될 수 있습니다.
...
## 6. 데이터 공유
당사는 사용자의 개인정보를 판매하지 않습니다. 제3자 SDK의 데이터 처리는 각 제공업체의 약관 및 정책을 따릅니다.

## 7. 문의
문의사항이 있으시면 judasiscariot055@gmail.com으로 연락해주시기 바랍니다.

## 8. 변경사항
본 방침은 업데이트될 수 있습니다. 최신 버전은 이 페이지에 게시됩니다.
...
- 選択した動画から抽出された音声は、処理および再開サポートのために端末に一時的に保存される場合があります。
...
## 6. データの共有
当社は個人データを販売しません。サードパーティSDKによるデータ処理は、各プロバイダーの利用規約とポリシーに従います。

## 7. お問い合わせ
ご質問がある場合は、judasiscariot055@gmail.comまでご連絡ください。

## 8. 変更
このポリシーは更新される場合があります。最新版はこのページに公開されます。
